...
function FotoUpload($fupload_name,$tbl){
  //direktori gambar
  switch ($tbl) {
    case 'participant':
      $vdir_upload = "../../Pictures/participant/";
    break;
    case 'quest':
      $vdir_upload = "../../Pictures/quest/";
    break;
    case 'user':
...
function uploadImageSlide($fupload_name){
  //direktori gambar
  $vdir_upload = "../img_slide/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function uploadTranfer($fupload_name){
  //direktori gambar
  $vdir_upload = "buktitranfer/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
